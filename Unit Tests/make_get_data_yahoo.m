...
symbol = 'VAS.AX';
test_4 = get_data_yahoo(symbol, ...
    'interval', 'd');
disp('Created test_4 dataset.')
pause(1)

symbol = 'VGB.AX';
test_5 = get_data_yahoo(symbol, ...
    'start', '03-10-2012', ...
    'finish', '16-07-2014', ...
    'format', 'dd-mm-yyyy', ...
    'interval', 'w');
...
symbol = {'GOOG', 'FB'};
test_10 = get_data_yahoo(symbol, ...
    'interval', 'd');
disp('Created test_10 dataset.')
pause(1)

symbol = {'COKE', 'PEP'};
test_11 = get_data_yahoo(symbol, ...
    'start', '03-10-2012', ...
    'finish', '16-07-2014', ...
    'format', 'dd-mm-yyyy', ...
    'interval', 'w');
