...
symbol = 'IBM';
test_1 = get_data_quandl(symbol, 'token', token);
disp('Created test_1 dataset.');
pause(1);

symbol = 'HPQ';
test_2 = get_data_quandl(symbol, 'start', '27-01-2012', ...
...
test_3 = get_data_quandl(symbol, 'start', start, 'finish', finish, ...
    'format', 'numeric', 'token', token);
disp('Created test_3 dataset.');
pause(1);

symbol = 'GE';
test_4 = get_data_quandl(symbol, 'interval', 'd', 'token', token);
disp('Created test_4 dataset.');
pause(1);

symbol = 'MSFT';
test_5 = get_data_quandl(symbol, 'start', '03-10-2012', ...
...
test_6 = get_data_quandl(symbol, 'start', start, 'finish', finish, ...
    'format', 'numeric', 'interval', 'm', 'token', token);
disp('Created test_6 dataset.');
pause(1);

symbol = {'GOOG', 'FB'};
test_7 = get_data_quandl(symbol, 'token', token);
disp('Created test_7 dataset.');
pause(1);

symbol = {'COKE', 'PEP'};
test_8 = get_data_quandl(symbol, 'start', '27-01-2012', ...
    'finish', '17-07-2014', 'format', 'dd-mm-yyyy', 'token', token);
...
start = datenum('07-05-2012', 'dd-mm-yyyy');
finish = datenum('16-07-2014', 'dd-mm-yyyy');
test_9 = get_data_quandl(symbol, 'start', start, 'finish', finish, ...
    'format', 'numeric', 'token', token);
disp('Created test_9 dataset.');
pause(1);

symbol = {'MCD', 'BKW'};
test_10 = get_data_quandl(symbol, 'interval', 'd', 'token', token);
disp('Created test_10 dataset.');
pause(1);

symbol = {'AMZN', 'NFLX'};
test_11 = get_data_quandl(symbol, 'start', '03-10-2012', ...
    'finish', '16-07-2014', 'format', 'dd-mm-yyyy', ...
    'interval', 'w', 'token', token);
...
start = datenum('14-10-2011', 'dd-mm-yyyy');
finish = datenum('17-07-2014', 'dd-mm-yyyy');
test_12 = get_data_quandl(symbol, 'start', start, 'finish', finish, ...
    'format', 'numeric', 'interval', 'm', 'token', token);
disp('Created test_12 dataset.');
pause(1);

symbol = 'FNZ.NZ';
test_13 = get_data_quandl(symbol, 'feed', 'GOOG', 'token', token);
disp('Created test_13 dataset.');
pause(1);

symbol = 'VEU.AX';
test_14 = get_data_quandl(symbol, 'feed', 'GOOG', ...
...
start = datenum('07-05-2012', 'dd-mm-yyyy');
finish = datenum('16-07-2014', 'dd-mm-yyyy');
test_15 = get_data_quandl(symbol, 'feed', 'GOOG', 'start', start, ...
    'finish', finish, 'format', 'numeric', 'token', token);
disp('Created test_15 dataset.');
pause(1);

symbol = 'VAS.AX';
test_16 = get_data_quandl(symbol, 'feed', 'GOOG', 'interval', 'd');
disp('Created test_16 dataset.');
pause(1);

symbol = 'VGB.AX';
test_17 = get_data_quandl(symbol, 'feed', 'GOOG', ...
...
start = datenum('14-10-2011', 'dd-mm-yyyy');
finish = datenum('17-07-2014', 'dd-mm-yyyy');
test_18 = get_data_quandl(symbol, 'feed', 'GOOG', 'start', start, ...
...
symbol = {'IBM', 'HPQ'};
test_19 = get_data_quandl(symbol, 'feed', 'GOOG', 'token', token);
disp('Created test_19 dataset.');
pause(1);

symbol = {'WAB', 'GE'};
test_20 = get_data_quandl(symbol, 'feed', 'GOOG', ...
    'start', '27-01-2012', 'finish', '17-07-2014', ...
    'format', 'dd-mm-yyyy', 'token', token);
...
start = datenum('07-05-2012', 'dd-mm-yyyy');
finish = datenum('16-07-2014', 'dd-mm-yyyy');
test_21 = get_data_quandl(symbol, 'feed', 'GOOG', 'start', start, ...
    'finish', finish, 'format', 'numeric', 'token', token);
disp('Created test_21 dataset.');
pause(1);

symbol = {'GOOG', 'FB'};
test_22 = get_data_quandl(symbol, 'feed', 'GOOG', 'interval', 'd', ...
    'token', token);
disp('Created test_22 dataset.');
pause(1);

symbol = {'COKE', 'PEP'};
test_23 = get_data_quandl(symbol, 'feed', 'GOOG', ...
    'start', '03-10-2012', 'finish', '16-07-2014', ...
    'format', 'dd-mm-yyyy', 'interval', 'w', 'token', token);
...
start = datenum('14-10-2011', 'dd-mm-yyyy');
finish = datenum('17-07-2014', 'dd-mm-yyyy');
test_24 = get_data_quandl(symbol, 'feed', 'GOOG', 'start', start, ...
    'finish', finish, 'format', 'numeric', 'interval', 'm', ...
    'token', token);
...
symbol = 'IBM';
test_25 = get_data_quandl(symbol, 'feed', 'YAHOO', 'token', token);
disp('Created test_25 dataset.');
pause(1);

symbol = 'HPQ';
test_26 = get_data_quandl(symbol, 'feed', 'YAHOO', ...
    'start', '27-01-2012', 'finish', '17-07-2014', ...
    'format', 'dd-mm-yyyy', 'token', token);
...
start = datenum('07-05-2012', 'dd-mm-yyyy');
finish = datenum('16-07-2014', 'dd-mm-yyyy');
test_27 = get_data_quandl(symbol, 'feed', 'YAHOO', 'start', start, ...
    'finish', finish, 'format', 'numeric', 'token', token);
disp('Created test_27 dataset.');
pause(1);

symbol = 'GE';
test_28 = get_data_quandl(symbol, 'feed', 'YAHOO', 'interval', 'd', ...
    'token', token);
disp('Created test_28 dataset.');
pause(1);

symbol = 'MSFT';
test_29 = get_data_quandl(symbol, 'feed', 'YAHOO', ...
    'start', '03-10-2012', 'finish', '16-07-2014', ...
    'format', 'dd-mm-yyyy', 'interval', 'w', 'token', token);
...
start = datenum('14-10-2011', 'dd-mm-yyyy');
finish = datenum('17-07-2014', 'dd-mm-yyyy');
test_30 = get_data_quandl(symbol, 'feed', 'YAHOO', 'start', start, ...
    'finish', finish, 'format', 'numeric', 'interval', 'm', ...
    'token', token);
...
symbol = {'GOOG', 'FB'};
test_31 = get_data_quandl(symbol, 'feed', 'YAHOO', 'token', token);
disp('Created test_31 dataset.');
pause(1);

symbol = {'COKE', 'PEP'};
test_32 = get_data_quandl(symbol, 'feed', 'YAHOO', ...
    'start', '27-01-2012', 'finish', '17-07-2014', ...
    'format', 'dd-mm-yyyy', 'token', token);
...
start = datenum('07-05-2012', 'dd-mm-yyyy');
finish = datenum('16-07-2014', 'dd-mm-yyyy');
test_33 = get_data_quandl(symbol, 'feed', 'YAHOO', 'start', start, ...
    'finish', finish, 'format', 'numeric', 'token', token);
disp('Created test_33 dataset.');
pause(1);

symbol = {'MCD', 'BKW'};
test_34 = get_data_quandl(symbol, 'feed', 'YAHOO', 'interval', 'd', ...
    'token', token);
disp('Created test_34 dataset.');
pause(1);

symbol = {'AMZN', 'NFLX'};
test_35 = get_data_quandl(symbol, 'feed', 'YAHOO', ...
    'start', '03-10-2012', 'finish', '16-07-2014', ...
    'format', 'dd-mm-yyyy', 'interval', 'w', 'token', token);
...
start = datenum('14-10-2011', 'dd-mm-yyyy');
finish = datenum('17-07-2014', 'dd-mm-yyyy');
test_36 = get_data_quandl(symbol, 'feed', 'YAHOO', ...
